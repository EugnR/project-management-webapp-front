function createDiv() {
    ...
    // newDiv.className = "new-div"; // Добавляем класс для стилизации (необязательно)
    // newDiv.innerHTML = "<strong>Всем привет!</strong> Вы прочитали важное сообщение.";

    // // Добавляем текст внутрь div (необязательно)
    // var divText = document.createTextNode("Новый элемент div");
